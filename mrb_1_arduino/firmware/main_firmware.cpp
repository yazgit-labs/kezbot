...
char base_link_name[] = "/mrb_1/base_link";
char odom_name[] = "/mrb_1/base";

ros::Publisher ros_odom("/mrb_1/pose2d", &pose2d);
...
ros::Subscriber<geometry_msgs::Twist> sub("/mrb_1/cmd_vel", &cmd_vel_handle );
