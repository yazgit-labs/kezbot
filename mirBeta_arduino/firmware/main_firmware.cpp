...
char base_link_name[] = "/mirBeta/base_link";
char odom_name[] = "/mirBeta/base";

ros::Publisher ros_odom("/mirBeta/pose2d", &pose2d);
...
ros::Subscriber<geometry_msgs::Twist> sub("/mirBeta/cmd_vel", &cmd_vel_handle );
